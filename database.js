...
// --- ARMI DA TEST (Danger Room) ---
    "ARMA DA TEST MULTIPLA": { b: 4, dam: 15, ammo: "NORMALE, AP, DA, EXP, SHOCK, VIRAL, E/M, PARA, BREAKER", ranges: { p3: 16, p0: 32, m3: 48 } },
    "SPADA DA TEST": { b: 1, dam: 14, ammo: "DA", isCC: true }
};
...
// ============================================================================
// 🧪 DANGER ROOM: TRUPPE E ARMI DA TEST (Da rimuovere prima di un torneo vero)
// ============================================================================

const unitaDaTest = [
    { id: "test_00", nome: "TEST (Bersaglio Base)", tipo: "LI", bs: 12, ph: 11, cc: 15, wip: 13, arm: 2, bts: 3, w: 1, s: 2, weapon: "Combi Rifle", skills: "", equip: "" },
    { id: "test_01", nome: "TEST (Mimetismo -3)", tipo: "LI", bs: 12, ph: 11, cc: 15, wip: 13, arm: 2, bts: 3, w: 1, s: 2, weapon: "Combi Rifle", skills: "Mimetism", equip: "" },
    { id: "test_02", nome: "TEST (Mimetismo -6)", tipo: "LI", bs: 12, ph: 11, cc: 15, wip: 13, arm: 2, bts: 3, w: 1, s: 2, weapon: "Combi Rifle", skills: "Mimetism (-6)", equip: "" },
    { id: "test_03", nome: "TEST (Visore MSV L1)", tipo: "LI", bs: 12, ph: 11, cc: 15, wip: 13, arm: 2, bts: 3, w: 1, s: 2, weapon: "Combi Rifle", skills: "MSV L1", equip: "" },
    { id: "test_04", nome: "TEST (Visore MSV L2)", tipo: "LI", bs: 12, ph: 11, cc: 15, wip: 13, arm: 2, bts: 3, w: 1, s: 2, weapon: "Combi Rifle", skills: "MSV L2", equip: "" },
    { id: "test_05", nome: "TEST (Tutte le Munizioni)", tipo: "LI", bs: 12, ph: 11, cc: 15, wip: 13, arm: 2, bts: 3, w: 1, s: 2, weapon: "ARMA DA TEST MULTIPLA", skills: "", equip: "" },
    { id: "test_06", nome: "TEST (Attacco Guidato)", tipo: "REM", bs: 12, ph: 11, cc: 15, wip: 13, arm: 2, bts: 3, w: 1, s: 3, weapon: "Guided Missile Launcher", skills: "BS Attack (Guided)", equip: "" },
    { id: "test_07", nome: "TEST (Maestro CC)", tipo: "HI", bs: 12, ph: 14, cc: 22, wip: 13, arm: 4, bts: 3, w: 2, s: 2, weapon: "SPADA DA TEST", skills: "Martial Arts", equip: "" },
    { id: "test_08", nome: "TEST (Hacker Base)", tipo: "LI", bs: 12, ph: 11, cc: 15, wip: 14, arm: 1, bts: 6, w: 1, s: 2, weapon: "Combi Rifle", skills: "Hacker", equip: "Hacking Device" },
    { id: "test_09", nome: "TEST (Impersonation 2)", tipo: "LI", bs: 12, ph: 11, cc: 15, wip: 13, arm: 1, bts: 3, w: 1, s: 2, weapon: "Boarding Shotgun", skills: "Impersonation-2", equip: "" },
    { id: "test_10", nome: "TEST (Sesto Senso)", tipo: "LI", bs: 12, ph: 11, cc: 15, wip: 13, arm: 2, bts: 3, w: 1, s: 2, weapon: "Combi Rifle", skills: "Sixth Sense", equip: "" },
    
    // --- LE NUOVE CAVIE ---
    { id: "test_11", nome: "TEST (Attacco a Sorpresa)", tipo: "LI", bs: 12, ph: 11, cc: 15, wip: 13, arm: 2, bts: 3, w: 1, s: 2, weapon: "Combi Rifle", skills: "Surprise Attack, Mimetism (-3)", equip: "" },
    { id: "test_12", nome: "TEST (TAG Corazzato)", tipo: "TAG", bs: 14, ph: 14, cc: 16, wip: 13, arm: 8, bts: 6, str: 3, s: 7, weapon: "HMG", skills: "Hackable", equip: "" }
];

if(window.DB_NOMADI) window.DB_NOMADI.push(...unitaDaTest);
if(window.DB_PANO) window.DB_PANO.push(...unitaDaTest);
